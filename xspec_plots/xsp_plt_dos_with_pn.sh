...
cd /Users/silver/box/phd/pro/87a/nus/plt/dos_with_pn/
...
# data 5:5 g3.grp
# data 6:6 g3.grp
# @dos_em10_011_pl0_g3.xcm
# data 1 none/
# data 1 none/
# data 1 none/
# data 1 none/
# data 1 none/
# newpar 13 0.9653751649214658
# ignore **-3. 65.-**
...
# I copy pasted from dos_em10_011_pl0_g3.xcm
wei = np.array([1., 1., 6.64, 6.64])
rgs2nus = np.array([0.782828, 0.907105, 0.990829, 0.976189]) 
rgs2nus = np.average(rgs2nus, weights=wei)
rgs2nus = 1. # fixed in xspec: newpar 1 0.9653751649214658
rgs2xmm = 1. # fixed in xspec: newpar 13 1.07852
...
a1.annotate('\$\chi^{2}/\mathrm{DoF}=2008/1745=1.15\$', (15, 5e-11))
plt.savefig('/Users/silver/box/phd/pro/87a/nus/art/fig/dos_with_pn_g3.pdf', bbox_inches='tight', pad_inches=0.1, dpi=300)
"
