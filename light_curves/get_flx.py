...
nus_soft = np.array(nus_soft)
nus_full = np.array(nus_full)
nus_hard = np.array(nus_hard)
...
xmm_soft = np.array(xmm_soft)
xmm_esft = np.array(xmm_esft)
xmm_vsft = np.array(xmm_vsft)
xmm_full = np.array(xmm_full)
xmm_hard = np.array(xmm_hard)
...
ct = dat[:,0]
cxo_soft = dat[:,1:4]*1e-13
cxo_hard = dat[:,4:7]*1e-13

dat = np.loadtxt('/Users/silver/box/sci/lib/f/frank16/xmm_flx.txt')
xm2_t = dat[:,0]
xm2_soft = dat[:,1:4]*1e-13
xm2_hard = dat[:,4:7]*1e-13
...
out = '/Users/silver/box/phd/pro/87a/nus/art/fig/hardness.pdf'
plt.savefig(out, bbox_inches='tight', pad_inches=0.1, dpi=300)

ax1.legend(loc='lower left')
plt.ylim(bottom=0)
out = '/Users/silver/box/phd/pro/87a/nus/art/fig/hardness_0.pdf'
plt.savefig(out, bbox_inches='tight', pad_inches=0.1, dpi=300)
# plt.show()
...
out = '/Users/silver/box/phd/pro/87a/nus/art/fig/lc_lin.pdf'
plt.savefig(out, bbox_inches='tight', pad_inches=0.1, dpi=300)
# plt.show()

ax1.set_ylim(bottom=1.e-13)
ax1.set_yscale('log')
ax2.set_ylim(bottom=0.1)
ax2.set_yscale('log')
ax1.legend(h,l, ncol=2, loc='lower right')
out = '/Users/silver/box/phd/pro/87a/nus/art/fig/lc_log.pdf'
plt.savefig(out, bbox_inches='tight', pad_inches=0.1, dpi=300)
# plt.show()
