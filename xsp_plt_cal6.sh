...
cd /Users/silver/box/phd/pro/87a/nus/plt/cal6/
...
data 4:4 g3.grp
data 5:5 g3.grp
@co2_v2_no_err_g3.xcm
data 1 none/
data 1 none/
data 1 none/
data 1 none/
newpar 1 0.9745422094240836
ignore **-3. 65.-**
...
# I copy pasted from co2_v2_no_err_g3.xcm
wei = np.array([1., 1., 6.64, 6.64])
rgs2nus = np.array([0.791271, 0.918577, 1.00164, 0.983474])
...
a1.annotate('I. \$\chi^{2}/\mathrm{DoF}=2559/1749=1.46\$', (15, 5e-11))
plt.savefig('/Users/silver/box/phd/pro/87a/nus/art/fig/cal6.pdf', bbox_inches='tight', pad_inches=0.1, dpi=300)
"
