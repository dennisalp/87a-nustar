...
# Same as xsp_lim_co2 but with Gamma=2.5
#
# This actually does not get the limit.
# It compares the goodness of fit between the three component shock model and
# two component model plus a cutoff pl with Gamma=2.5. This is like replacing the
...
xspec < tmp_lim_co2_2p5.xcm > log/lim_co2_2p5.txt
