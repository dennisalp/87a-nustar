...
# This is G3, epoch 3, with pn and with 0.88T=Tx and constants in 0.85-1.15.
# this is bascially the best effort at managing the systematics

cd /Users/silver/box/phd/pro/87a/nus/plt/cal3/
...
# I copy pasted from com_v2_0p8b_g3.xcm
wei = np.array([1., 1., 6.64, 6.64])
rgs2nus = 0.85/np.array([0.85, 0.85, 0.853912, 0.85])
...
a3.set_xlim([0.3, 65.])
plt.savefig('/Users/silver/box/phd/pro/87a/nus/art/fig/cal3.pdf', bbox_inches='tight', pad_inches=0.1, dpi=300)

print('333.32 with 132 degrees of freedom in 0.3 to 10 keV')
print('227.03 with 118 degrees of freedom in 0.8 to 10 keV')
"
