...
cd /Users/silver/box/phd/pro/87a/nus/plt/cal5/
...
data 4:4 g3.grp
data 5:5 g3.grp
@com_v2_no_err_g3.xcm
data 1 none/
data 1 none/
data 1 none/
data 1 none/
newpar 1 0.9418441989528794
ignore **-3. 65.-**
...
# I copy pasted from com_v2_no_err_g3.xcm
wei = np.array([1., 1., 6.64, 6.64])
rgs2nus = np.array([0.763888, 0.88567, 0.96791, 0.951039])
...
a1.annotate('II. \$\chi^{2}/\mathrm{DoF}=2059/1746=1.18\$', (15, 5e-11))
plt.savefig('/Users/silver/box/phd/pro/87a/nus/art/fig/cal5.pdf', bbox_inches='tight', pad_inches=0.1, dpi=300)
"
