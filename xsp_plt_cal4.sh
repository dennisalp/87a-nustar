...
# This is G3, epoch 3, with pn and with 0.88T=Tx and constants free.
# this is bascially the best effort at managing the systematics

cd /Users/silver/box/phd/pro/87a/nus/plt/cal4/
...
# I copy pasted from com_v2_0p88_g3.xcm
wei = np.array([1., 1., 6.64, 6.64])
rgs2nus = np.array([0.668008, 0.778546, 0.84921, 0.834858])
rgs2nus = np.average(rgs2nus, weights=wei)
rgs2nus = 1. # fixed in xspec: newpar 1 0.8264898900523558
rgs2xmm = 1.06618
...
a3.set_xlim([0.3, 65.])
a1.annotate('IV. \$\chi^{2}/\mathrm{DoF}=2019/1746=1.16\$', (15, 5e-11))
plt.savefig('/Users/silver/box/phd/pro/87a/nus/art/fig/cal4.pdf', bbox_inches='tight', pad_inches=0.1, dpi=300)
"
