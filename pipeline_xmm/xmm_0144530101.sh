...
tbin=60
tbpy=4
pn_src="circle(25365.126,27895.466,600)"
pn_bkg="circle(28358.363,27443.25,1030)"
...
# evselect table=$(ls P${id}R1U003*EVENLI0000.FIT) \
#          timebinsize=100 \
#          rateset=${id}_r1_bkg_lc.fits \
#          makeratecolumn=yes \
#          maketimecolumn=yes \
#          expression="(CCDNR==9)&&(REGION($(ls P${id}R1U003*SRCLI_0000.FIT):RGS1_BACKGROUND,M_LAMBDA,XDSP_CORR))"
# evselect table=$(ls P${id}R2U002*EVENLI0000.FIT) \
#          timebinsize=100 \
#          rateset=${id}_r2_bkg_lc.fits \
#          makeratecolumn=yes \
#          maketimecolumn=yes \
#          expression="(CCDNR==9)&&(REGION($(ls P${id}R2U002*SRCLI_0000.FIT):RGS2_BACKGROUND,M_LAMBDA,XDSP_CORR))"
...
evselect table="$(ls P${id}R1U003*EVENLI0000.FIT):EVENTS" \
...
evselect table="$(ls P${id}R1U003*EVENLI0000.FIT):EVENTS" \
         ...
         expression="REGION($(ls P${id}R1U003*SRCLI_0000.FIT):RGS1_SRC1_SPATIAL,M_LAMBDA,XDSP_CORR)"
rgsimplot endispset="${id}_r1_pi.fits" spatialset="${id}_r1_xd.fits" \
          srcidlist="1" srclistset="$(ls P${id}R1U003*SRCLI_0000.FIT)" \
          device=/cps plotfile=r1.ps
evselect table="$(ls P${id}R2U002*EVENLI0000.FIT):EVENTS" \
         imageset="${id}_r2_xd.fits" xcolumn="M_LAMBDA" ycolumn="XDSP_CORR"
evselect table="$(ls P${id}R2U002*EVENLI0000.FIT):EVENTS" \
         imageset="${id}_r2_pi.fits" xcolumn="M_LAMBDA" ycolumn="PI"\
         yimagemin=0 yimagemax=3000 \
         expression="REGION($(ls P${id}R2U002*SRCLI_0000.FIT):RGS2_SRC1_SPATIAL,M_LAMBDA,XDSP_CORR)"
rgsimplot endispset="${id}_r2_pi.fits" spatialset="${id}_r2_xd.fits" \
          srcidlist="1" srclistset="$(ls P${id}R2U002*SRCLI_0000.FIT)" \
...
# grppha "$(ls P${id}R1U003*SRSPEC1001.FIT)" \
#        "!${id}_r1o1_grp.fits" \
#        << EOF
# chkey BACKFILE $(ls P${id}R1U003*BGSPEC1001.FIT)
# chkey RESPFILE $(ls P${id}R1U003*RSPMAT1001.FIT)
# group min 25
# exit
# EOF
# grppha "$(ls P${id}R2U002*SRSPEC1001.FIT)" \
#        "!${id}_r2o1_grp.fits" \
#        << EOF
# chkey BACKFILE $(ls P${id}R2U002*BGSPEC1001.FIT)
# chkey RESPFILE $(ls P${id}R2U002*RSPMAT1001.FIT)
# group min 25
# exit
# EOF
# grppha "$(ls P${id}R1U003*SRSPEC2001.FIT)" \
#        "!${id}_r1o2_grp.fits" \
#        << EOF
# chkey BACKFILE $(ls P${id}R1U003*BGSPEC2001.FIT)
# chkey RESPFILE $(ls P${id}R1U003*RSPMAT2001.FIT)
# group min 25
# exit
# EOF
# grppha "$(ls P${id}R2U002*SRSPEC2001.FIT)" \
#        "!${id}_r2o2_grp.fits" \
#        << EOF
# chkey BACKFILE $(ls P${id}R2U002*BGSPEC2001.FIT)
# chkey RESPFILE $(ls P${id}R2U002*RSPMAT2001.FIT)
# group min 25
# exit
# EOF
