...
# Fit the standard 3 shock components model, with pn but decouple the T and EM for NuSTAR
...
save model com_v2_untie_t+em_g1
...
fit
save model com_v2_untie_t+em_${4}
# error 5 20 22 26 41 43 47 62 64
# 
# tclout param 5
