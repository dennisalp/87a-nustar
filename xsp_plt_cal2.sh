...
# This is G3, epoch 3, without pn. the standard fit but with pn overplotted (constant factor adjusted)
# this is to show the magnitude of the calibration errors.

cd /Users/silver/box/phd/pro/87a/nus/plt/cal2/
...
# I copy pasted from com_v2_no_pn_g3.xcm
wei = np.array([1., 1., 6.64, 6.64])
rgs2nus = np.array([0.768661, 0.892938, 0.974751, 0.960792])
rgs2nus = np.average(rgs2nus, weights=wei)

rgs2xmm = 1.05519 # this is taking the model and adjusting a constant to pn 0.3-10 keV
# This is a poor fit: 576.99 with 140 degrees of freedom
...
a3.set_xlim([0.3, 65.])
a1.annotate('III. \$\chi^{2}/\mathrm{DoF}=1771/1620=1.09\$', (15, 5e-11))
plt.savefig('/Users/silver/box/phd/pro/87a/nus/art/fig/cal2.pdf', bbox_inches='tight', pad_inches=0.1, dpi=300)


print('1771.37 --> 1757.62 when adding PL')
"
